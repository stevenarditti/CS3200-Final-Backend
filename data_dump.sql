...
INSERT INTO `movies` VALUES (1,'Cars 2',NULL,5,120,NULL),(2,'Cars',NULL,1,117,NULL);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `reviews_BEFORE_INSERT` BEFORE INSERT ON `reviews` FOR EACH ROW BEGIN
...
-- Dump completed on 2019-06-19 17:10:58
